...
export default function MuscleHeatmap() {
  ...
  return (
    <section className="rounded-2xl border border-white/10 bg-slate-950/80 p-6 text-white shadow-xl lg:p-8">
      <div className="flex flex-col gap-8 lg:flex-row lg:items-start">
        <div className="flex-1">
          <div className="mb-4 flex flex-wrap items-center gap-3 text-xs">
            <span className="rounded-full border border-orange-500/40 bg-orange-500/10 px-3 py-1 font-semibold uppercase tracking-[0.18em] text-orange-200">
              MuscleSync • Anatomy Heatmap
            </span>
            <span className="rounded-full border border-white/10 bg-white/5 px-3 py-1 text-slate-300">
              {loading
                ? "Syncing muscle telemetry…"
                : error
                ? "Fallback anatomy data in use"
                : "Live data from /api/muscles"}
            </span>
          </div>

          <h2 className="text-2xl font-semibold tracking-tight text-white sm:text-3xl">
            Front‑view muscular system heatmap
          </h2>
          <p className="mt-3 text-sm text-slate-300">
            Each major muscle group is mapped to API‑driven activation scores and tinted directly on the SVG anatomy.
          </p>
          ...
          <div className="mt-6 rounded-2xl border border-white/10 bg-slate-900/80 p-4">
            ...
            >
              <title id="muscle-heatmap-title">MuscleSync muscular anatomy heatmap</title>
        ...
        <div className="flex-1 rounded-2xl border border-white/10 bg-slate-900/80 p-5">
